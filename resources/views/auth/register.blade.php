    ...
    <div class="w-6/12 bg-white p-6 rounded-lg">
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="mb-4">
                ...
                class="bg-gray-100 border-2 w-full rounded-lg p-4 @error('name') border-red-500 @enderror" value="{{old('name')}}" />
            ...
            <div class="mb-4">
                ...
                class="bg-gray-100 border-2 w-full rounded-lg p-4 @error('name') border-red-500 @enderror" value="{{old('username')}}" />
            ...
            <div class="mb-4">
                ...
                class="bg-gray-100 border-2 w-full rounded-lg p-4" value="" />
            </div>
            <div>
